...
class AlbumEntityJsonAdapter(
  moshi: Moshi
) : JsonAdapter<AlbumEntity>() {
  ...
  override fun toString(): String = buildString(33) {
      append("GeneratedJsonAdapter(").append("AlbumEntity").append(')') }

  override fun fromJson(reader: JsonReader): AlbumEntity {
    var id: Int? = null
  ...
  override fun toJson(writer: JsonWriter, value: AlbumEntity?) {
    if (value == null) {
