...
class ArtistAlbumsEntityJsonAdapter(
  moshi: Moshi
) : JsonAdapter<ArtistAlbumsEntity>() {
  private val options: JsonReader.Options = JsonReader.Options.of("data", "total", "prev", "next")

  private val listOfArtistAlbumEntityAdapter:
      JsonAdapter<List<ArtistAlbumsEntity.ArtistAlbumEntity>> =
      moshi.adapter(Types.newParameterizedType(List::class.java,
      ArtistAlbumsEntity.ArtistAlbumEntity::class.java), emptySet(), "data")
  ...
  override fun toString(): String = buildString(40) {
      append("GeneratedJsonAdapter(").append("ArtistAlbumsEntity").append(')') }

  override fun fromJson(reader: JsonReader): ArtistAlbumsEntity {
    var data: List<ArtistAlbumsEntity.ArtistAlbumEntity>? = null
    var total: Int? = null
    ...
    while (reader.hasNext()) {
      when (reader.selectName(options)) {
        0 -> data = listOfArtistAlbumEntityAdapter.fromJson(reader) ?:
  ...
  override fun toJson(writer: JsonWriter, value: ArtistAlbumsEntity?) {
    if (value == null) {
      throw NullPointerException("value was null! Wrap in .nullSafe() to write nullable values.")
    }
    writer.beginObject()
    writer.name("data")
    listOfArtistAlbumEntityAdapter.toJson(writer, value.data)
    writer.name("total")
