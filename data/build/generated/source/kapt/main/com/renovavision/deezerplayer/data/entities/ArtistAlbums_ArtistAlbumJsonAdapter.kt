...
class ArtistAlbums_ArtistAlbumJsonAdapter(
  moshi: Moshi
) : JsonAdapter<ArtistAlbums.ArtistAlbum>() {
  ...
  override fun toString(): String = buildString(46) {
      append("GeneratedJsonAdapter(").append("ArtistAlbums.ArtistAlbum").append(')') }

  override fun fromJson(reader: JsonReader): ArtistAlbums.ArtistAlbum {
    var id: Int? = null
    ...
    reader.endObject()
    return ArtistAlbums.ArtistAlbum(
  ...
  override fun toJson(writer: JsonWriter, value: ArtistAlbums.ArtistAlbum?) {
    if (value == null) {
