...
class ContributorJsonAdapter(
  moshi: Moshi
) : JsonAdapter<Contributor>() {
  ...
  override fun toString(): String = buildString(33) {
      append("GeneratedJsonAdapter(").append("Contributor").append(')') }

  override fun fromJson(reader: JsonReader): Contributor {
    var id: Int? = null
  ...
  override fun toJson(writer: JsonWriter, value: Contributor?) {
    if (value == null) {
