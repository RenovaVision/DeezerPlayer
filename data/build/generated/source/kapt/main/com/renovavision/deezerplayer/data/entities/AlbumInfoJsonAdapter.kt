...
class AlbumInfoJsonAdapter(
  moshi: Moshi
) : JsonAdapter<AlbumInfo>() {
  ...
  private val nullableGenresAdapter: JsonAdapter<AlbumInfo.Genres?> =
      moshi.adapter(AlbumInfo.Genres::class.java, emptySet(), "genres")
  ...
  private val authorAdapter: JsonAdapter<AlbumInfo.Author> =
      moshi.adapter(AlbumInfo.Author::class.java, emptySet(), "artist")

  private val tracksAdapter: JsonAdapter<AlbumInfo.Tracks> =
      moshi.adapter(AlbumInfo.Tracks::class.java, emptySet(), "tracks")

  override fun toString(): String = buildString(31) {
      append("GeneratedJsonAdapter(").append("AlbumInfo").append(')') }

  override fun fromJson(reader: JsonReader): AlbumInfo {
    var id: Int? = null
    ...
    var genres: AlbumInfo.Genres? = null
    ...
    var artist: AlbumInfo.Author? = null
    var type: String? = null
    var tracks: AlbumInfo.Tracks? = null
    reader.beginObject()
    while (reader.hasNext()) {
      when (reader.selectName(options)) {
        ...
        11 -> genres = nullableGenresAdapter.fromJson(reader)
        ...
        24 -> contributors = nullableListOfContributorAdapter.fromJson(reader)
        25 -> artist = authorAdapter.fromJson(reader) ?: throw Util.unexpectedNull("artist",
            "artist", reader)
        26 -> type = stringAdapter.fromJson(reader) ?: throw Util.unexpectedNull("type", "type",
            reader)
        27 -> tracks = tracksAdapter.fromJson(reader) ?: throw Util.unexpectedNull("tracks",
            "tracks", reader)
        -1 -> {
  ...
  override fun toJson(writer: JsonWriter, value: AlbumInfo?) {
    if (value == null) {
    ...
    writer.name("genres")
    nullableGenresAdapter.toJson(writer, value.genres)
    writer.name("label")
    ...
    writer.name("artist")
    authorAdapter.toJson(writer, value.artist)
    writer.name("type")
    stringAdapter.toJson(writer, value.type)
    writer.name("tracks")
    tracksAdapter.toJson(writer, value.tracks)
    writer.endObject()
  }
}
