...
class TopTracksJsonAdapter(
  moshi: Moshi
) : JsonAdapter<TopTracks>() {
  private val options: JsonReader.Options = JsonReader.Options.of("data", "total", "prev", "next")

  private val listOfTrackAdapter: JsonAdapter<List<TopTracks.Track>> =
      moshi.adapter(Types.newParameterizedType(List::class.java, TopTracks.Track::class.java),
      emptySet(), "data")
  ...
  override fun toString(): String = buildString(31) {
      append("GeneratedJsonAdapter(").append("TopTracks").append(')') }

  override fun fromJson(reader: JsonReader): TopTracks {
    var data: List<TopTracks.Track>? = null
    var total: Int? = null
    ...
    while (reader.hasNext()) {
      when (reader.selectName(options)) {
        0 -> data = listOfTrackAdapter.fromJson(reader) ?: throw Util.unexpectedNull("data", "data",
            reader)
  ...
  override fun toJson(writer: JsonWriter, value: TopTracks?) {
    if (value == null) {
      throw NullPointerException("value was null! Wrap in .nullSafe() to write nullable values.")
    }
    writer.beginObject()
    writer.name("data")
    listOfTrackAdapter.toJson(writer, value.data)
    writer.name("total")
