...
class MainArtistEntityJsonAdapter(
  moshi: Moshi
) : JsonAdapter<MainArtistEntity>() {
  ...
  override fun toString(): String = buildString(38) {
      append("GeneratedJsonAdapter(").append("MainArtistEntity").append(')') }

  override fun fromJson(reader: JsonReader): MainArtistEntity {
    var id: Int? = null
  ...
  override fun toJson(writer: JsonWriter, value: MainArtistEntity?) {
    if (value == null) {
