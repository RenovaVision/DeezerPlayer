...
class TopArtistTracksEntity_ArtistTrackEntityJsonAdapter(
  moshi: Moshi
) : JsonAdapter<TopArtistTracksEntity.ArtistTrackEntity>() {
  ...
  override fun toString(): String = buildString(61) {
      append("GeneratedJsonAdapter(").append("TopArtistTracksEntity.ArtistTrackEntity").append(')')
      }

  override fun fromJson(reader: JsonReader): TopArtistTracksEntity.ArtistTrackEntity {
    var id: Int? = null
    ...
    while (reader.hasNext()) {
      when (reader.selectName(options)) {
        ...
        11 -> preview = stringAdapter.fromJson(reader) ?: throw Util.unexpectedNull("preview",
            "preview", reader)
        12 -> contributors = nullableListOfContributorEntityAdapter.fromJson(reader)
        13 -> artist = mainArtistEntityAdapter.fromJson(reader) ?:
    ...
    reader.endObject()
    return TopArtistTracksEntity.ArtistTrackEntity(
  ...
  override fun toJson(writer: JsonWriter, value: TopArtistTracksEntity.ArtistTrackEntity?) {
    if (value == null) {
