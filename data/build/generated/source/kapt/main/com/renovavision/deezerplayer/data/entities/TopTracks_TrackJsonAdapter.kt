...
class TopTracks_TrackJsonAdapter(
  moshi: Moshi
) : JsonAdapter<TopTracks.Track>() {
  ...
  private val artistAdapter: JsonAdapter<Artist> = moshi.adapter(Artist::class.java, emptySet(),
      "artist")
  ...
  override fun toString(): String = buildString(37) {
      append("GeneratedJsonAdapter(").append("TopTracks.Track").append(')') }

  override fun fromJson(reader: JsonReader): TopTracks.Track {
    var id: Int? = null
    ...
    while (reader.hasNext()) {
      when (reader.selectName(options)) {
        ...
        13 -> artist = artistAdapter.fromJson(reader) ?: throw Util.unexpectedNull("artist",
            "artist", reader)
  ...
  override fun toJson(writer: JsonWriter, value: TopTracks.Track?) {
    if (value == null) {
    ...
    writer.name("artist")
    artistAdapter.toJson(writer, value.artist)
    writer.name("album")
