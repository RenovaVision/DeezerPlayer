...
class AlbumDetailsEntity_TracksEntity_AlbumTrackEntityJsonAdapter(
  moshi: Moshi
) : JsonAdapter<AlbumDetailsEntity.TracksEntity.AlbumTrackEntity>() {
  ...
  private val mainArtistEntityAdapter: JsonAdapter<MainArtistEntity> =
      moshi.adapter(MainArtistEntity::class.java, emptySet(), "artist")

  override fun toString(): String = buildString(70) {
      append("GeneratedJsonAdapter(").append("AlbumDetailsEntity.TracksEntity.AlbumTrackEntity").append(')')
      }

  override fun fromJson(reader: JsonReader): AlbumDetailsEntity.TracksEntity.AlbumTrackEntity {
    var id: Int? = null
    ...
    var artist: MainArtistEntity? = null
    ...
    while (reader.hasNext()) {
      when (reader.selectName(options)) {
        ...
        11 -> preview = stringAdapter.fromJson(reader) ?: throw Util.unexpectedNull("preview",
            "preview", reader)
        12 -> artist = mainArtistEntityAdapter.fromJson(reader) ?:
            throw Util.unexpectedNull("artist", "artist", reader)
    ...
    reader.endObject()
    return AlbumDetailsEntity.TracksEntity.AlbumTrackEntity(
  ...
  override fun toJson(writer: JsonWriter,
      value: AlbumDetailsEntity.TracksEntity.AlbumTrackEntity?) {
    if (value == null) {
    ...
    writer.name("artist")
    mainArtistEntityAdapter.toJson(writer, value.artist)
    writer.name("type")
