...
class ArtistEntityJsonAdapter(
  moshi: Moshi
) : JsonAdapter<ArtistEntity>() {
  ...
  override fun toString(): String = buildString(34) {
      append("GeneratedJsonAdapter(").append("ArtistEntity").append(')') }

  override fun fromJson(reader: JsonReader): ArtistEntity {
    var id: Int? = null
  ...
  override fun toJson(writer: JsonWriter, value: ArtistEntity?) {
    if (value == null) {
