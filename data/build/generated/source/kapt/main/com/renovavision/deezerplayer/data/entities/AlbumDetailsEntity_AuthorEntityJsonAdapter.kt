...
class AlbumDetailsEntity_AuthorEntityJsonAdapter(
  moshi: Moshi
) : JsonAdapter<AlbumDetailsEntity.AuthorEntity>() {
  ...
  override fun toString(): String = buildString(53) {
      append("GeneratedJsonAdapter(").append("AlbumDetailsEntity.AuthorEntity").append(')') }

  override fun fromJson(reader: JsonReader): AlbumDetailsEntity.AuthorEntity {
    var id: Int? = null
    ...
    reader.endObject()
    return AlbumDetailsEntity.AuthorEntity(
  ...
  override fun toJson(writer: JsonWriter, value: AlbumDetailsEntity.AuthorEntity?) {
    if (value == null) {
