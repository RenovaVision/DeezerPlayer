...
class AlbumDetailsEntity_GenresEntity_GenreEntityJsonAdapter(
  moshi: Moshi
) : JsonAdapter<AlbumDetailsEntity.GenresEntity.GenreEntity>() {
  ...
  override fun toString(): String = buildString(65) {
      append("GeneratedJsonAdapter(").append("AlbumDetailsEntity.GenresEntity.GenreEntity").append(')')
      }

  override fun fromJson(reader: JsonReader): AlbumDetailsEntity.GenresEntity.GenreEntity {
    var id: Int? = null
    ...
    reader.endObject()
    return AlbumDetailsEntity.GenresEntity.GenreEntity(
  ...
  override fun toJson(writer: JsonWriter, value: AlbumDetailsEntity.GenresEntity.GenreEntity?) {
    if (value == null) {
